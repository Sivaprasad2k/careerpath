  ...
  return (
    <div className="min-h-screen bg-darkBg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute w-80 h-80 rounded-full bg-brand-600/20 bg-orb -top-20 -right-20"
      />
      <motion.div
        animate={{
          x: [0, 40, -30, 0],
        ...
        className="absolute w-96 h-96 rounded-full bg-indigo-500/10 bg-orb -bottom-20 -left-20"
      />
      ...
      >
        ...
        <p className="text-center text-xs text-gray-400 mt-6 font-medium">
          No account?{' '}
          <Link to="/register" className="text-brand-500 font-bold hover:text-brand-400 transition-colors hover:underline">
            Create one
          </Link>
        </p>
      </motion.div>
